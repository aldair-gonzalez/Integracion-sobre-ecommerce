import { CodeError } from '../lib/errors/constants/code.js'
import { response } from '../utils/response.js'
import { logger } from '../utils/logger.js'

export const isError = (err, req, res) => {
  logger.error(`${err.cause}: ${err.message}`)
  const responseStatus = response({ status: CodeError.INTERNAL_SERVER_ERROR, payload: null, error: { cause: err.cause, message: err.message } })
